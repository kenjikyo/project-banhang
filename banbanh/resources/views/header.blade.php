                ...
                <div class="beta-comp">
                    ...
                    <div class="cart">
                        ...
                        <div class="beta-dropdown cart-body">
                            ...
                            <div class="cart-item">
                                <a href="{{route('deletecart',$item['item']['id'])}}" class="cart-item-delete"><i class="fa fa-times"></i></a>  
                                <div class="media">
                                    <a class="pull-left" href="{{route('chi-tiet-san-pham',$item['item']['id'])}}"><img src="source/image/product/{{$item['item']['image']}}" alt=""></a>
                                    <div class="media-body">
                                        <span class="cart-item-title">{{$item['item']['name']}}</span>
                                        <span class="cart-item-amount">{{$item['qty']}}*<span>
                                                @if($item['item']['promotion_price'] !=0 ){{ $item['item']['promotion_price'] }} VNĐ
                                                @else {{$item['item']['unit_price']}} VNĐ
                                                @endif
                                        </span></span>
                                    </div>
                                </div>
