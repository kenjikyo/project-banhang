    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-7" style="padding-bottom:120px">
                ...
                @endif
                <form action="admin/type_product/them" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        <label>Mô tả</label>
                        <textarea class="form-control" name="description" id=""  rows="3" placeholder="Mô tả loại sản phẩm"></textarea>
                    </div>
                    <div class="form-group">
